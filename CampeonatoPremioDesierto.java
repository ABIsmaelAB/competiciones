...
{
    public CampeonatoPremioDesierto(){
        Organizacion organizacion;
        organizacion = Organizacion.getInstance(1, 3, Collections.reverseOrder(new ComparadorDistanciaCircuito()));
        ...
        Escuderia e1 = new Escuderia("Peugeot", Collections.reverseOrder(new ComparadorPuntosDestrezaPiloto()), new ComparadorCombustibleCoche());
        ...
        organizacion.inscripcionEscuderia(e1);
        e1=null;
        e1 = new Escuderia("Seat", Collections.reverseOrder(new ComparadorPuntosDestrezaPiloto()), new ComparadorCombustibleCoche());
